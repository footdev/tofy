...
public interface AttractionService {
	...
	public List<AttractionDto> attractionInfo(Map<String, String> hMap) throws Exception;  //여행지 정보 추출
	public AttractionDescDto selectDescription(String contentId) throws Exception; //Modal 여행지 상세 정보 추출
	public List<AttractionDto> selectTrips(List<String> tList);  // 여행지 id 값을 바탕으로 정보 가져오기
